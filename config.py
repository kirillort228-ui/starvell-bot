...
class Config:
    ...
    crypto_pay_api_base: str = "https://pay.crypt.bot/api"
...
def load_config() -> Config:
    ...
    return Config(
        ...
        crypto_pay_token=clean_env_value(os.getenv("CRYPTO_PAY_TOKEN", "")),
        crypto_pay_api_base=clean_env_value(os.getenv("CRYPTO_PAY_API_BASE", "https://pay.crypt.bot/api")) or "https://pay.crypt.bot/api",
        crypto_pay_accepted_assets=clean_env_value(os.getenv("CRYPTO_PAY_ACCEPTED_ASSETS", "USDT,TON,BTC,ETH,LTC,BNB,TRX,USDC")) or "USDT,TON,BTC,ETH,LTC,BNB,TRX,USDC",
        required_channel_id=clean_env_value(os.getenv("REQUIRED_CHANNEL_ID", "")),
        required_channel_url=clean_env_value(os.getenv("REQUIRED_CHANNEL_URL", "")),
    )
