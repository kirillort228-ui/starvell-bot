...
FALLBACK_NEXT_BUILD_ID = "NzQuXbo4EDoGpiOH6ZurF"
...
class StarvellClient:
    ...
    async def get_build_id(self) -> str:
        """Возвращает текущий Next.js buildId, а при ошибке — сохранённый резервный."""
        try:
            response = await self._request("GET", "https://starvell.com/")
