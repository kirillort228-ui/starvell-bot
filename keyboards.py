...
def support_keyboard(support_url: str | None = None, support_username: str | None = None) -> InlineKeyboardMarkup:
    buttons = []
    ...
    if url:
        buttons.append([InlineKeyboardButton(text="💬 Написать в поддержку", url=url)])
    buttons.append([InlineKeyboardButton(text="‹ Назад в меню", callback_data="support:back")])
