...
async def check_one_account(bot: Bot, db: Database, account: StarvellAccount) -> None:
    ...
    try:
        ...
        for chat in extract_chats(data):
            ...
            # Auto-delivery must be checked even when Starvell marks the system
            # notification as read. The old code skipped all read chats here.
            try:
            ...
            # Normal autoresponses and Telegram notifications remain unread-only.
